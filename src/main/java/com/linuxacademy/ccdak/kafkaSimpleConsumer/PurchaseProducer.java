...
public class PurchaseProducer {
    public void produce(){
        ...
        config.put(ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG, org.apache.kafka.common.serialization.StringSerializer.class.getName());
        ...
        int i = 0;
        while (true) {
            Purchase purchase = new Purchase((i++ + 1) * 11, products[rnd.nextInt(products.length)], rnd.nextInt(20) + 1,i);
